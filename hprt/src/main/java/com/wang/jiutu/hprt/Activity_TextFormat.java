...
//		String[] sList = getResources().getStringArray(R.array.activity_text_bold);
	...
	public void onClickPrint(View view) 
	{
    	...
    	try
    	{
			...
			HPRTPrinterHelper.printAreaSize("100", "30");
			HPRTPrinterHelper.CLS();
			HPRTPrinterHelper.Codepage(publicFunction.getCodePageIndex(codepage));
			HPRTPrinterHelper.LanguageEncode="UTF-8";
	    	HPRTPrinterHelper.printText(txtformat_x.getText().toString(), txtformat_y.getText().toString(), formatfont, ""+qrcoderotation, x_multiplication, txtText.getText().toString());
