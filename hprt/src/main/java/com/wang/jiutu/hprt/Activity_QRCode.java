...
{	
	...
	public void onClickPrint(View view) 
	{
    	...
    	try
    	{
	    	...
	    	HPRTPrinterHelper.printAreaSize("100", "80");
			HPRTPrinterHelper.CLS();
	//		HPRTPrinterHelper.printqrcode("123");
	    	HPRTPrinterHelper.printQRcode(txtqrcode_x.getText().toString(), txtqrcode_y.getText().toString(), QRCodeLevel, ""+QRCodeSize, QRCodeModel, ""+qrcoderotation, txtQRCodeData.getText().toString());
